      ...
      <section class="lg:col-span-3 space-y-8">
        ...
        <!-- <section aria-labelledby="layanan-pacing-title">
          ...
          <p class="text-xs sm:text-sm mb-4">
            Layanan - layanan yang terdapat di Desa Pacing
          </p>
          <div
            aria-label="Daftar layanan Desa Pacing"
            class="flex space-x-3 overflow-x-auto scrollbar-hide py-2"
          >
            <button
              aria-label="PPID"
              class="flex-shrink-0 w-28 h-28 bg-white rounded-xl shadow-lg flex flex-col items-center justify-center p-4"
            >
              <img
                alt="Logo PPID Desa Pacing"
                class="mb-2 w-14 h-14 object-contain"
                src="https://storage.googleapis.com/a1aa/image/042b005d-a697-4ae8-13df-e599d1787548.jpg"
              />
              <span class="text-xs text-center text-gray-800 font-semibold"
                >PPID</span
              >
            </button>
            <button
        ...
        <section aria-labelledby="berita-title" class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a
              href="#"
              data-id="1"
              class="berita-link block hover:shadow-lg transition"
            >
              <article
                aria-label="Berita 1"
            ...
            >
              ...
              >
                ...
                <p
                  class="text-gray-600 text-[9px] sm:text-xs mb-2 line-clamp-3"
                >
                  PACING- Bupati PACING, Hamenang Wijaya Ismoyo mengajak para
                  admin media sosial dalam forum...
                </p>
                <time
                  class="text-gray-400 text-[9px] sm:text-xs"
                  datetime="2025-07-03"
            ...
            >
              ...
              >
                ...
                <p
                  class="text-gray-600 text-[9px] sm:text-xs mb-2 line-clamp-3"
                >
                  PACING – Dinas Komunikasi dan Informatika (Diskominfo)
                  Kabupaten Pacing menggelar sosialisasi...
                </p>
                <time
                  class="text-gray-400 text-[9px] sm:text-xs"
                  datetime="2025-07-01"
            ...
            >
              ...
              >
                ...
                <p
                  class="text-gray-600 text-[9px] sm:text-xs mb-2 line-clamp-3"
                >
                  PACING – Pemerintah Kabupaten (Pemkab) Pacing menjalin kerja
                  sama internasional dengan Pemerintah...
                </p>
                <time
                  class="text-gray-400 text-[9px] sm:text-xs"
                  datetime="2025-06-24"
