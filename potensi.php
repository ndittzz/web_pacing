          ...
          >
            ...
            <li class="relative group">
              ...
              <div
                class="absolute left-0 mt-2 w-40 bg-white border border-gray-200 shadow-lg opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100 transition-all duration-300 origin-top z-50"
              >
                <a href="data_penduduk.php" class="block px-4 py-2 hover:bg-gray-100"
                  >Data Penduduk</a
                >
                <a href="data_keuangan.php" class="block px-4 py-2 hover:bg-gray-100"
                  >Data Keuangan</a
                >
              </div>
            </li>
      ...
      >
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div class="flex items-center">
              <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
              <span class="text-gray-700 font-semibold">Potensi</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <section aria-labelledby="berita-title" class="mt-6 space-y-4">
        ...
        >
         ...
         <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Berita item 1 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="1">
          <article
            aria-label="Berita 1"
          ...
          <!-- Berita item 2 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="2">
          <article
            aria-label="Berita 2"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 3 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="3">
          <article
            aria-label="Berita 3"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 4 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="4">
          <article
            aria-label="Berita 4"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 5 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="5">
          <article
            aria-label="Berita 5"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 6 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="6">
          <article
            aria-label="Berita 6"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 7 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="7">
          <article
            aria-label="Berita 7"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 8 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="8">
          <article
            aria-label="Berita 8"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 9 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="9">
          <article
            aria-label="Berita 9"
            class="bg-white rounded-lg shadow-md p-3 flex flex-col"
          >
          ...
          <!-- Berita item 10 -->
           <a href="#" class="potensi-link block hover:shadow-lg transition" data-id="10">
          <article
