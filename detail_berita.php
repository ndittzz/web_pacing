...
$id = intval($_GET['id']);
$result = $konek->query("SELECT * FROM berita WHERE id=$id");
...
<html class="scroll-smooth" lang="id">
  ...
  <body class="bg-white text-black">
      ...
      >
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div class="flex items-center">
              <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
              <span class="text-gray-700 font-semibold">Detail Berita</span>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <main class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 mt-6">
      ...
      <div class="mb-6">
        <a href="berita.php" class="inline-flex items-center px-4 py-2 bg-red-700 text-white rounded hover:bg-red-900 text-sm">
    ...
    <footer class="bg-black text-white text-xs sm:text-sm mt-10">
      ...
      >
        ...
        <div>
          ...
          <p>
            Pengunjung Hari ini : <strong>96 Pengunjung</strong><br />
            Kemarin : <strong>137 Pengunjung</strong><br />
            Bulan ini : <strong>919 Pengunjung</strong><br />
            Tahun ini : <strong>9723 Pengunjung</strong><br />
            Total : <strong>21559 Pengunjung</strong>
          </p>
        </div>
        <div>
