  ...
  <body class="bg-white text-black">
          ...
          <li>
            <div class="flex items-center">
              ...
              <span class="text-gray-700 font-semibold"
                >Struktur Pemerintahan Desa Pacing</span
              >
            </div>
          </li>
        </ol>
    ...
    >
      ...
      >
        ...
        >
          Struktur Organisasi Pemerintahan Desa Pacing
        </h1>
