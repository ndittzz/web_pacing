...
?><!-- admin/sejarah.php - Manajemen Sejarah Desa -->
<!DOCTYPE html>
<html lang="id">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              ...
              <!-- <div class="col-sm-6 text-right">
                <a href="sejarah_create.php" class="btn btn-primary">
        ...
        <section class="content">
          <div class="container-fluid">
            <!-- Bagian 1: Legenda Desa -->
            <div class="card mb-4">
              <div class="card-header bg-info">
                <h5 class="card-title">Legenda Desa</h5>
                <a
                  href="sejarah_edit_legenda.php"
            ...
            <!-- Bagian 2: Sejarah Umum Desa -->
            <div class="card mb-4">
              <div class="card-header bg-success">
                <h5 class="card-title">Sejarah Umum</h5>
                <a
                  href="sejarah_edit_umum.php"
                  class="btn btn-warning btn-sm float-right"
                >
                  <i class="fas fa-edit"></i> Edit
                </a>
            ...
            <!-- Bagian 3: Daftar Kepala Desa -->
            <div class="card mb-4">
              <div class="card-header bg-warning">
                <h5 class="card-title">Daftar Kepala Desa</h5>
                <a
                  href="sejarah_kepaladesa_create.php"
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <!-- Contoh data statis, nanti bisa di-loop dengan PHP -->
                    <tr>
                      <td>1</td>
                      <td>Pak Surono</td>
                      <td>Dusun I</td>
                      <td>1990 - 1995</td>
                      <td>Tokoh karismatik</td>
                      <td>
                        <a
                          href="sejarah_kepaladesa_edit.php"
                          class="btn btn-sm btn-warning"
                        >
                          <i class="fas fa-edit"></i>
                        </a>
                        <a
                          href="proses_hapus_kepaladesa.php?id=1"
            ...
            <!-- Bagian 4: Penutup / Ucapan -->
            <div class="card mb-4">
              <div class="card-header bg-secondary">
                <h5 class="card-title">Penutup</h5>
                <a
                  href="sejarah_edit_penutup.php"
                  class="btn btn-warning btn-sm float-right"
                >
                  <i class="fas fa-edit"></i> Edit
                </a>
