...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($penutup) {
        // update
        mysqli_query($konek, "UPDATE sejarah_desa SET konten='$konten' WHERE bagian='penutup'");
    } else {
        // insert
        mysqli_query($konek, "INSERT INTO sejarah_desa (bagian, konten) VALUES ('penutup', '$konten')");
    }
...
<html lang="id">
  <head>
    ...
    <title>Edit Penutup Sejarah Desa - Desa Pacing</title>
  ...
  <body class="hold-transition sidebar-mini">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Edit Penutup Sejarah Desa</h1>
              </div>
            </div>
          </div>
        </div>
                ...
                <form method="post">
                  <div class="form-group">
                    ...
                    <div id="editor-deskripsi" style="height: 250px">
                      <?= htmlspecialchars_decode($penutup['konten'] ?? '') ?>
                    </div>
    ...
    <script>
      ...
      <?php if ($penutup && $penutup['konten']) { ?>
        quillDeskripsi.root.innerHTML = <?= json_encode($penutup['konten']) ?>;
      <?php } ?>
