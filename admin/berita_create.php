...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        $stmt = $konek->prepare("INSERT INTO berita (judul, deskripsi, gambar, penulis, tanggal) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssss", $judul, $deskripsi, $gambar, $penulis, $tanggal);
...
<html lang="id">
  <head>
    ...
    <title>Tambah Berita - Desa Pacing</title>
    <link
      rel="stylesheet"
